...
## Concepts
- [[computer-use-in-llms]] — Agentic UI control where a model acts from screen input toward a goal.
- [[context-engineering]] — Boundary-setting approach for agent systems that treats context as a managed resource.
